...
# Day 3 - Cond. stmts, logical operators, code blocks and scope
...
#         # if photo == "Y":
#         #     bill += 3
#         #     print(f"The ticket cost for kids is: {bill}")
#     elif age <= 18:
#         bill += 7
#         # photo = input("Do you want photo. Y or N: ")
#         # if photo == "Y":
#         #     bill += 3
#         #     print(f"The ticket cost for children is: {bill}")
#     elif age >= 45 <= 55:
...
#         # if photo == "Y":
#         #     bill += 3
#         #     print(f"The ticket cost for adults is: {bill}")
#     photo = input("Do you want photo. Y or N: ")
#     if photo == "Y":
#         bill += 3
# # else:
